...
wrap.configure = function(opts) {
  ...
  if (opts.expand === true) {
    opts.expand = _.keys(_options.defaults);
...
Varity.prototype.checkArg = function (arg) {
  ...
  if (_.isString(arg)) {
    ...
    arg.expand = typeof arg.expand !== 'undefined' ? arg.expand : (arg.default || arg.nonEmpty ? true : false);
...
Varity.prototype.pushArg = function(e) {
  ...
  if (e.expand || ~self.options.expand.indexOf(e.type)) {
    if (e.default) {
      return _.isFunction(e.default) ? e.default() : e.default;
    } else {
      return _.isFunction(p) && e.type !== 'Function' ? p() : p;
    }
  } else {
    return undefined;
  }
